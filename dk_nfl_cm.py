...
pos_col = find_column(df, ["position","positions","pos","roster position"])
...
if gen_btn:
    ...
    with st.spinner("Generating..."):
        for lineup_num, lineup in enumerate(
            optimizer.optimize(n=num_lineups, exposure_strategy=AfterEachExposureStrategy, max_exposure=max_exposure),
            start=1
        ):
            row = {}
